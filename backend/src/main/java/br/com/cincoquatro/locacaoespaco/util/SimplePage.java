...
public class SimplePage<T> extends PageImpl<T> {
	...
	private static final long serialVersionUID = -4979206058494879107L;

	@JsonCreator
	public SimplePage(@JsonProperty("content") final List<T> content, @JsonProperty("totalElements") final long totalElements,
			@JsonProperty("totalPages") final int totalPages, @JsonProperty("page") final int page, @JsonProperty("size") final int size,
