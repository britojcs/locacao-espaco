...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMissingServletRequestParameter(
        ...
        String error = "Faltando parâmetro " + ex.getParameterName();
    ...
    protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(
        ...
        builder.append(" MediaType não é suportado. Os MediaTypes suportados são ");
    ...
    protected ResponseEntity<Object> handleHttpMessageNotWritable(HttpMessageNotWritableException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        String error = "Erro ao gravar saída JSON";
    ...
    protected ResponseEntity<Object> handleNoHandlerFoundException(
        ...
        ApiError apiError = new ApiError(BAD_REQUEST);
        apiError.setMessage(String.format("Não foi possível encontrar o método %s para URL %s", ex.getHttpMethod(), ex.getRequestURL()));
